    ...
    <footer
      ...
      > 
        <div className="hidden lg:relative lg:col-span-2 lg:block">
          <img
            alt="Art"
            src="https://img.freepik.com/free-photo/neon-tropical-monstera-leaf-banner_53876-138943.jpg?w=900&t=st=1667619189~exp=1667619789~hmac=24f58265a277ff1f4446497df49fab4fe6d3e10c1e2875f6a0e9bd10ae7ab579"
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <p className="font-medium">More Plans</p>
